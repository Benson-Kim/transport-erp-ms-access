...
' UPDATED: November 23, 2025 – Encapsulated globals with properties, fixed activity reset,
...
ErrorHandler:
    modUtilities.LogError MODULE_NAME & "_InitializeGlobalVariables", Err.Number, Err.Description, ""
...
ErrorHandler:
    modUtilities.LogError MODULE_NAME & "_GetSystemSetting", Err.Number, Err.Description, _
...
ErrorHandler:
    modUtilities.LogError MODULE_NAME & "_SetSystemSetting", Err.Number, Err.Description, _
...
ErrorHandler:
    modUtilities.LogError MODULE_NAME & "_CheckSessionTimeout", Err.Number, Err.Description
